...
const Hero = () => {
    ...
    return <Box
        ...
        <img src="/logo.png" alt="" className="w-[200px]  h-[200px] md:w-[200px] md:h-[200px] llg:h-[300px]  llg:w-[250px]  object-cover top-[50px] md:top-[100px]  absolute left-[90px] md:left-[130px] lg:left-[140px] llg:left-[200px] " />
