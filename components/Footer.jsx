...
const Footer = () => {
    ...
    return <Grid className='text-white md:px-20 llg:px-[110px]'
        ...
        <Grid item xs={12} sx={{
            ...
            <Typography className="py-2 text-white  px-2 text-[13px]" textAlign="left" color={colors.grey[100]} variant="body1" fontFamily="Lato">
        ...
        <Grid item xs={12} md={5} className="flex flex-col md:flex-row justify-start items-start  gap-20">
